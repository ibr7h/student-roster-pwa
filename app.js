...
function printAttendanceReport(){setPrintPage('portrait');document.body.classList.add('print-attendance-report');showView('attendance',false);requestAnimationFrame(()=>window.print())}
...
function printClassReport(){setPrintPage('portrait');document.body.classList.add('print-class-summary');showView('reports',false);requestAnimationFrame(()=>window.print())}
