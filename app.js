...
const APP_VERSION=globalThis.APP_VERSION||document.querySelector('#versionBadge')?.textContent?.replace(/^v/,'')||'4.2.0';
...
function renderReports(){
  ...
  $('#reportPrintHeader').innerHTML=classOfficialSheet(c,period);
